    ...
    <div className="pt-1 bg-gradient-to-b from-gray-900 to-[#00629B]">
      ...
      <section className="relative mt-16 py-20 bg-gradient-to-b from-gray100 to-[#00629B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            Our Mission & Vision of fostering technological innovation and
            ...
            >
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h2 className="text-xl font-semibold text-[#00629B] mb-3">
                    JCER Student Branch (STB60208149)
                  </h2>
                  <p className="text-gray-600">
                    Imagine a vibrant community of like-minded peers, all fueled
                    by a shared passion for technology and its potential to
                    solve global challenges. That is exactly what IEEE Student
                    Branch is all about.
                    <br />
                    <br />
                    At the core of our mission is the understanding that growth
                    is not a linear path but a dynamic process. We recognize
                    that each student is unique, possessing distinct talents,
            ...
            >
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    To be the leading student organization in advancing
                    technology and inspiring future leaders in the field of
                  ...
                  <p className="text-gray-600">
                    ...
                    benefit of humanity, while providing a platform for students
