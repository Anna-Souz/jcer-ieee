export const events: Event[] = [
  ...
  },
  {
    ...
    description: 'Prakashan is an in-house technical exhibition that provides first-year students with an opportunity to apply what they learn and gain confidence to aim higher.',
    date: '30 Dec 2023',
    location: 'Auditorium',
